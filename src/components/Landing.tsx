...
export const Landing = () =>{
    return (
        <div className="h-screen w-screen overflow-hidden">
            ...
            {/* <div className="bg-green-300 absolute opacity-60 dark:opacity-30 rounded-full w-30 h-30 md:w-[48rem] md:h-[48rem] " /> */}
            {/* <div className="md:-right-[10rem] -right-40 -bottom-40 md:-bottom-[28rem] bg-green-300 absolute opacity-60 dark:opacity-30 rounded-full w-96 h-96 md:w-[48rem] md:h-[48rem]" /> */}
